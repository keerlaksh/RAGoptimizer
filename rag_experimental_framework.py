# rag_experimental_framework.py
"""
A Controlled Experimental Framework for RAG Pipeline Evaluation

This system treats RAG design as a scientific experiment, measuring:
1. Information Flow Integrity (retrieval → generation coupling)
2. Retrieval-Generation Coupling (how retrieval quality affects answers)
3. Hallucination vs Coverage Trade-off (groundedness vs usefulness)
"""
...
# Controlled Variables (held constant across experiments)
DOCS_FOLDER = "docs"
TOP_K_DEFAULT = 5
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "")

# LLaMA Model Configuration (Groq supports multiple LLaMA models)
# Updated to use currently supported models (as of 2024)
# Note: Model names may vary - check https://console.groq.com/docs/models for latest
LLAMA_MODELS = {
...
DEFAULT_LLAMA_MODEL = "llama-3.1-70b-versatile"  # Updated to currently supported model
...
# ============================================
# EMBEDDING MODELS (Independent Variable)
# ============================================
